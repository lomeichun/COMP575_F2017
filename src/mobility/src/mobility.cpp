...
//compute local_average_heading
    ...
    if (num_o_r == 3)
    {
        ...
        if (index == 0)
        {
         ...
         // phase 1 (index1): 1st normalize, 2nd multiply by weights, 3rd alignment, 4th cohesion, 5th separation
...
// phase 2 (index2): 1st normalize, 2nd multiply by weights, 3rd alignment, 4th cohesion, 5th separation
        } else if(index == 2)
        {
            g_avg[0] = ro3[1];
            g_avg[1] = ro3[0];
            ...
            xdif = strtof((rovers_data[2][1]).c_str(),0) - strtof((rovers_data[3][1]).c_str(),0);
            ydif = strtof((rovers_data[2][2]).c_str(),0) - strtof((rovers_data[3][2]).c_str(),0);
            di1_4 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[2][1]).c_str(),0) - strtof((rovers_data[4][1]).c_str(),0);
            ydif = strtof((rovers_data[2][2]).c_str(),0) - strtof((rovers_data[4][2]).c_str(),0);
            di1_5 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[2][1]).c_str(),0) - strtof((rovers_data[5][1]).c_str(),0);
            ydif = strtof((rovers_data[2][2]).c_str(),0) - strtof((rovers_data[5][2]).c_str(),0);
            di1_6 = sqrt(xdif*xdif + ydif*ydif);
...
//phase 3 (index3): 1st normalize, 2nd multiply by weights, 3rd alignment, 4th cohesion, 5th separation
           } else if(index == 3)
        {
            g_avg[0] = ro4[1];
            g_avg[1] = ro4[0];
            ...
            xdif = strtof((rovers_data[3][1]).c_str(),0) - strtof((rovers_data[0][1]).c_str(),0);
            ydif = strtof((rovers_data[3][2]).c_str(),0) - strtof((rovers_data[0][2]).c_str(),0);
            di1_2 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[3][1]).c_str(),0) - strtof((rovers_data[1][1]).c_str(),0);
            ydif = strtof((rovers_data[3][2]).c_str(),0) - strtof((rovers_data[1][2]).c_str(),0);
            ...
            xdif = strtof((rovers_data[3][1]).c_str(),0) - strtof((rovers_data[2][1]).c_str(),0);
            ydif = strtof((rovers_data[3][2]).c_str(),0) - strtof((rovers_data[2][2]).c_str(),0);
            di1_4 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[3][1]).c_str(),0) - strtof((rovers_data[4][1]).c_str(),0);
            ydif = strtof((rovers_data[3][2]).c_str(),0) - strtof((rovers_data[4][2]).c_str(),0);
            di1_5 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[3][1]).c_str(),0) - strtof((rovers_data[5][1]).c_str(),0);
            ydif = strtof((rovers_data[3][2]).c_str(),0) - strtof((rovers_data[5][2]).c_str(),0);
            di1_6 = sqrt(xdif*xdif + ydif*ydif);
     ...
     //phase 4 (index4): 1st normalize, 2nd multiply by weights, 3rd alignment, 4th cohesion, 5th separation
                    } else if(index == 4)
        {
            g_avg[0] = ro5[1];
            g_avg[1] = ro5[0];
            ...
            xdif = strtof((rovers_data[4][1]).c_str(),0) - strtof((rovers_data[0][1]).c_str(),0);
            ydif = strtof((rovers_data[4][2]).c_str(),0) - strtof((rovers_data[0][2]).c_str(),0);
            di1_2 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[4][1]).c_str(),0) - strtof((rovers_data[1][1]).c_str(),0);
            ydif = strtof((rovers_data[4][2]).c_str(),0) - strtof((rovers_data[1][2]).c_str(),0);
            di1_3 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[4][1]).c_str(),0) - strtof((rovers_data[2][1]).c_str(),0);
            ydif = strtof((rovers_data[4][2]).c_str(),0) - strtof((rovers_data[2][2]).c_str(),0);
            di1_4 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[4][1]).c_str(),0) - strtof((rovers_data[3][1]).c_str(),0);
            ydif = strtof((rovers_data[4][2]).c_str(),0) - strtof((rovers_data[3][2]).c_str(),0);
            di1_5 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[4][1]).c_str(),0) - strtof((rovers_data[5][1]).c_str(),0);
            ydif = strtof((rovers_data[4][2]).c_str(),0) - strtof((rovers_data[5][2]).c_str(),0);
            di1_6 = sqrt(xdif*xdif + ydif*ydif);
...
//phase 5 (index5): 1st normalize, 2nd multiply by weights, 3rd alignment, 4th cohesion, 5th separation (last)
                    } else if(index == 5)
        {
            g_avg[0] = ro6[1];
            g_avg[1] = ro6[0];
            ...
            xdif = strtof((rovers_data[5][1]).c_str(),0) - strtof((rovers_data[0][1]).c_str(),0);
            ydif = strtof((rovers_data[5][2]).c_str(),0) - strtof((rovers_data[0][2]).c_str(),0);
            di1_2 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[5][1]).c_str(),0) - strtof((rovers_data[1][1]).c_str(),0);
            ydif = strtof((rovers_data[5][2]).c_str(),0) - strtof((rovers_data[1][2]).c_str(),0);
            di1_3 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[5][1]).c_str(),0) - strtof((rovers_data[2][1]).c_str(),0);
            ydif = strtof((rovers_data[5][2]).c_str(),0) - strtof((rovers_data[2][2]).c_str(),0);
            di1_4 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[5][1]).c_str(),0) - strtof((rovers_data[3][1]).c_str(),0);
            ydif = strtof((rovers_data[5][2]).c_str(),0) - strtof((rovers_data[3][2]).c_str(),0);
            di1_5 = sqrt(xdif*xdif + ydif*ydif);
            ...
            xdif = strtof((rovers_data[5][1]).c_str(),0) - strtof((rovers_data[4][1]).c_str(),0);
            ydif = strtof((rovers_data[5][2]).c_str(),0) - strtof((rovers_data[4][2]).c_str(),0);
